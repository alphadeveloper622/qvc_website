...
const Index = (props: IButtonProps) => {
  return (
    <div
      className={`${props.className} poppins400 hero-button flex h-[100px] w-[100%]  items-center justify-end rounded-r-[4px] bg-[#A5221E] text-white md:h-[148px] md:max-w-[843px]`}
    >
