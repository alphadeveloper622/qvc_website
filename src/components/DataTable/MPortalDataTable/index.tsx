...
const Index = ({ columns, data }) => {
  ...
  return (
    <>
      <div
        className={`flex items-center border-0 border-gray-300 bg-white px-5 pt-4 `}
      >
        <select
          className="poppins400 block w-full border border-[#DADEE3] py-2 text-sm"
          placeholder="Show Account"
        >
          <option>Show Account: All</option>
        </select>
      </div>
      <div
        className={`flex justify-between gap-x-2 border-0 border-gray-300 bg-white px-5 py-4 `}
      >
        <label className="flex items-center">
          <span className="poppins400 mt-[5px] mr-3 text-[13px]">Show</span>
          <select
            className="block w-full border border-[#DADEE3] py-1"
                    ...
                    return (
                      <tr {...row.getRowProps()} className=" hover:bg-gray-50">
                        <td
                          ...
                          className="flex flex-col px-5 py-4 text-[12px]"
                          role="cell"
                        >
                          {row.cells[0].render('Cell')}
                          <div className="mt-1">
                            <span className=" text-gray-600">
                              Submitted:{row.cells[2].render('Cell')}
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </span>
                            <span className="text-gray-600">
                              Coins:{row.cells[3].render('Cell')}
                            </span>
                          </div>
                        </td>
                        <td
      ...
      {/* Pagination */}
      <div className="flex hidden items-center justify-between py-3">
