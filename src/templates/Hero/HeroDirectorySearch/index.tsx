  ...
  return (
    <Section padding={`${props.className} px-0`}>
      <div className="relative">
        ...
        >
          <h1
            className={`reveal-active fade-left mb-[9px] text-[26px] leading-[32.76px] md:mb-[15px] md:text-[33px] md:leading-[42px] lg:text-[3.6vw] lg:leading-[4.5vw] desktop:text-[52px] desktop:leading-[65.52px]`}
          >
            {title}
          </h1>
          <h2
            className={`reveal-active fade-bottom text-[16px] leading-[21.12px] md:text-[2vw] md:leading-[2.5vw] desktop:text-[28px] desktop:leading-[36.96px]`}
          >
            {description}
          </h2>
        </div>
      </div>
      <DirectorySearchForm className="reveal-active fade w-full md:absolute md:bottom-0 md:left-[50%] md:h-[7.5vw] md:translate-y-[50%] md:translate-x-[-50%]  md:px-[7vw] desktop:max-h-[174px] desktop:px-[100px]" />
    </Section>
  );
};
