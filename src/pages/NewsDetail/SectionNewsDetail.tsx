  ...
  return (
    ...
    >
      <div className="w-full pt-[34px] md:flex md:justify-between">
        ...
        >
          <p className={`poppins400 mb-[12px] font-[16px]`}>{date}</p>
          <div
        ...
        >
          <p className={`poppins700 mb-[12px] font-[22px]`}>RECENT NEWS</p>
          <div>
            <NewsStoryCard className={`mb-[27px]`} />
            <NewsStoryCard className={`mb-[27px]`} />
          </div>
        </div>
      </div>
